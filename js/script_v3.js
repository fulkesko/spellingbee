...
function ajustarTamanoNumero(numeroEl) {
  if (!numeroEl) return;

  const cont = numeroEl.parentElement || document.getElementById('container-numero') || document.body;
  ...
  numeroEl.style.fontSize = fontSizeEm + 'em';
